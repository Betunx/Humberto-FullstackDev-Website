  ...
  template: `
    ...
    >
      ...
      <div class="relative z-10 text-center px-6 max-w-4xl mx-auto w-full">
        ...
        >
          <span style="color:#00e5ff;">&gt;</span> system.init()
        </p>

        <!-- Heading -->
        <h1
          class="text-5xl sm:text-6xl md:text-7xl font-black tracking-wider mb-2 uppercase leading-tight"
        ...
        <p
          ...
          style="font-family: 'JetBrains Mono', monospace; color: #8b949e; font-size: 0.9rem;"
        >
          {{ t().description }}
        </p>
        ...
        <div class="flex items-center justify-center gap-6">
          ...
          <a
            ...
            style="color: #8b949e; border-color: rgba(0,255,65,0.3);"
            onmouseenter="this.style.color='#00ff41'; this.style.borderColor='#00ff41'; this.style.boxShadow='0 0 15px rgba(0,255,65,0.3)'"
            onmouseleave="this.style.color='#8b949e'; this.style.borderColor='rgba(0,255,65,0.3)'; this.style.boxShadow='none'"
            aria-label="GitHub"
          >
